...
"""
CONFIG_PATH = "tools/GroundingDINO_SwinT_OGC.py"
WEIGHTS_PATH = "output_final/checkpoint0014.pth"
...
"""
Step 1: Environment settings and model initialization for SAM 2 and Grounding DINO
"""
...
grounding_model = grounding_model.to(args.device)
...
"""
Step 2: Prompt Grounding DINO with fine-tuned model for box coordinates
"""
...
image_predictor.set_image(np.array(image_source))
